    ...
    <div className="container">
      <section className="mt-5">
        <div className="row text-center d-flex justify-content-center pt-5">
          ...
          <div className="col-md-2">
            <h6 className="text-uppercase font-weight-bold">
              <a href="https://mdglankush65.github.io/Portfolio/#contact" className="text-white"><FontAwesomeIcon icon={faArrowCircleRight} /> Contact</a>
            </h6>
          </div>
        </div>
      </section>
      ...
      <a href="https://mdglankush65.github.io/Portfolio/#contact" className="text-white me-4" target='blank'>
          <FontAwesomeIcon icon={faContactBook} />
        </a>
        <a href="mailto:mdglankush565@gmail.com" className="text-white me-4" target='blank'>
          <FontAwesomeIcon icon={faGoogle} />
        </a>
        <a href="https://www.linkedin.com/in/ankushmudgil/" className="text-white me-4" target='blank'>
          <FontAwesomeIcon icon={faLinkedinIn} />
        </a>
        <a href="https://github.com/mdglankush65/react-movie-site" className="text-white me-4" target='blank'>
