...
const Movies = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const genresResponse = await axios.get(`https://api.themoviedb.org/3/genre/tv/list?api_key=48e86327a174416fcd7a2a5e9ddf8ab6&language=hi-IN`);
            ...
            setNowplaying(nowPlayingResults.data.results);
            ...
            {isLoading ? (
                ...
                <div>
                    ...
                    <div className="product spad" style={{ margin: '30px' }}>
                        ...
                        <div className='boobo'>
                        {shows.map((show) => {
                if ((show.origin_country[0] === "IN" || show.origin_country[0] === "JP") && JSON.stringify(show.original_name) !== 'The Idol') {
                    const id = show.id
                    return (
